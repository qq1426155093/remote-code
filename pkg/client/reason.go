...
const (
	...
	ReasonAgentQueryNotFound       = string(rpcerror.AgentQueryNotFound)
	ReasonAgentQueryReplayDisabled = string(rpcerror.AgentQueryReplayDisabled)
	ReasonAgentSequenceInvalid     = string(rpcerror.AgentQuerySequenceInvalid)
	ReasonAgentQueryEventsPruned   = string(rpcerror.AgentQueryEventsPruned)
	ReasonAgentQueryObserverLimit  = string(rpcerror.AgentQueryObserverLimit)
	ReasonAgentQueryObserverLag    = string(rpcerror.AgentQueryObserverLag)
)
